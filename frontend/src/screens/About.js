...
import {getAllRealtorsandTopSeller } from '../actions/realtorsActions'
const About = () => {
  const dispatch =useDispatch()
// dispatch get top seller and get all realtors

const allrealtors= useSelector((state) => state.allRealtors)
const { realtors }= allrealtors
const topRealtor = useSelector((state) => state.topRealtor)
const { realtor }= topRealtor
useEffect(()=>{
dispatch(getAllRealtorsandTopSeller())
},[dispatch ])
